...
<p class="codex-meta">Godot 4.6 <span class="stack-sep">·</span> GDScript <span class="stack-sep">·</span> <span class="status status--shipping">shipping · v1.1.0</span></p>
...
<p class="codex-link">private, shipped v1.1.0</p>
